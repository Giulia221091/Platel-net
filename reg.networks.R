...
# ####
# proteins.UP.benign.DDAcounts
# proteins.UP.PDAC.DDAcounts
# write.table(file = "./PlatelNet/proteins.UP.benign.DDAcounts.txt",proteins.UP.benign.DDAcounts,quote = F)
# write.table(file = "./PlatelNet/proteins.UP.PDAC.DDAcounts.txt",proteins.UP.PDAC.DDAcounts,quote = F)
# write.table(file = "./PlatelNet/miRNA.UP.Benign.iso.txt",miRNA.UP.Benign.iso,quote = F)
# write.table(file = "./PlatelNet/miRNA.UP.PDAC.iso.txt",miRNA.UP.PDAC.iso.,quote = F)
# write.table(file = "./PlatelNet/miRNA.UP.Benign.canonical.txt",miRNA.UP.Benign.canonical,quote = F)
# write.table(file = "./PlatelNet/miRNA.UP.PDAC.canonical.txt",miRNA.UP.PDAC.canonical,quote = F)
# write.table(file = "./PlatelNet/mRNA.UP.PDAC.txt",mRNA.UP.PDAC,quote = F)
# write.table(file = "./PlatelNet/mRNA.UP.Benign.txt",mRNA.UP.Benign,quote = F)
# 
# 
# 
# 
...
# 
# 
# #### check for any RNA splicing factors
# 
# splicing_RNA <- read.table("/Users/Giulia/Downloads/geneset-15.txt",header = T)
# 
# head(splicing_RNA)
# 
# intersect(intersect(miRNA.mRNA.proteins.PDAC$gene,miRNA.premRNA.proteins.PDAC$gene),rownames(proteins.UP.PDAC.DDAcounts))
# 
# intersect(intersect(miRNA.mRNA.proteins.Benign$gene,miRNA.premRNA.proteins.Benign$gene),rownames(proteins.UP.benign.DDAcounts))
# 
# 
# ##### UP PDAC canonical
# miRNA.UP.PDAC.canonical <- read.table(file = "/Users/Giulia/Dropbox/TEP's_March2020/miRNA.UP.PDAC.canonical.txt")
# head(miRNA.UP.PDAC.canonical)
# intersect(miRNA.mRNA.proteins.PDAC$miRNA,rownames(miRNA.UP.PDAC.canonical))
# 
# miRNA.UP.Benign.canonical <- read.table(file = "/Users/Giulia/Dropbox/TEP's_March2020/miRNA.UP.Benign.canonical.txt")
# head(miRNA.UP.Benign.canonical)
# intersect(miRNA.mRNA.proteins.Benign$miRNA,rownames(miRNA.UP.PDAC.canonical))
# 
# 
# ### check with isomirs
# miRNA.UP.Benign.iso <- read.csv(file = "/Users/Giulia/Dropbox/TEP's_March2020/miRNA.UP.Benign.iso.txt",sep = "")
# miRNA.UP.PDAC.iso. <- read.csv(file = "/Users/Giulia/Dropbox/TEP's_March2020/miRNA.UP.PDAC.iso.txt",sep = "")
# miRNA.UP.PDAC.iso.$mir <- sapply(strsplit(rownames(miRNA.UP.PDAC.iso.),"_"), `[`, 2)
# intersect(miRNA.mRNA.proteins.PDAC$miRNA,miRNA.UP.Benign.iso$mir)
# 
# ############################# over-represntation in correlation data?#########
# 
# ##upload data
# miRNA.mRNA.proteins.PDAC <- openxlsx::read.xlsx("hyp_canonical.miRNA.PDAC.xlsx",sheet=1)
# miRNA.premRNA.proteins.PDAC <- openxlsx::read.xlsx("hyp_canonical.miRNA.PDAC.xlsx",sheet=2)
...
# isomiRNA.premRNA.proteins.PDAC <- read.csv("hyp_ISO_IntronmRNA.PDAC.txt",sep = " ")
# 
# intersect(miRNA.mRNA.proteins.PDAC$miRNA,miRNA.premRNA.proteins.PDAC$miRNA)
# intersect(miRNA.mRNA.proteins.PDAC$gene,miRNA.premRNA.proteins.PDAC$gene)
# intersect(isomiRNA.mRNA.proteins.PDAC$miRNA,isomiRNA.premRNA.proteins.PDAC$miRNA)
# intersect(isomiRNA.mRNA.proteins.PDAC$gene,isomiRNA.premRNA.proteins.PDAC$gene)
# intersect(intersect(miRNA.mRNA.proteins.PDAC$gene,miRNA.premRNA.proteins.PDAC$gene),intersect(isomiRNA.mRNA.proteins.PDAC$gene,isomiRNA.premRNA.proteins.PDAC$gene))
# intersect(intersect(miRNA.mRNA.proteins.PDAC$miRNA,miRNA.premRNA.proteins.PDAC$miRNA),intersect(isomiRNA.mRNA.proteins.PDAC$miRNA,isomiRNA.premRNA.proteins.PDAC$miRNA))
# 
# 
# 
# miRNA.mRNA.proteins.Benign <- openxlsx::read.xlsx("hyp_canonical.miRNA.Benign.xlsx",sheet=1)
...
# isomiRNA.premRNA.proteins.Benign <- read.csv("hyp_ISO_IntronmRNA.Benign.txt",sep = " ")
# 
# intersect(miRNA.mRNA.proteins.Benign$miRNA,miRNA.premRNA.proteins.Benign$miRNA)
# intersect(miRNA.mRNA.proteins.Benign$gene,miRNA.premRNA.proteins.Benign$gene)
# intersect(isomiRNA.mRNA.proteins.Benign$miRNA,isomiRNA.premRNA.proteins.Benign$miRNA)
# intersect(isomiRNA.mRNA.proteins.Benign$gene,isomiRNA.premRNA.proteins.Benign$gene)
# intersect(intersect(miRNA.mRNA.proteins.Benign$gene,miRNA.premRNA.proteins.Benign$gene),intersect(isomiRNA.mRNA.proteins.Benign$gene,isomiRNA.premRNA.proteins.Benign$gene))
# intersect(intersect(miRNA.mRNA.proteins.Benign$miRNA,miRNA.premRNA.proteins.Benign$miRNA),intersect(isomiRNA.mRNA.proteins.Benign$miRNA,isomiRNA.premRNA.proteins.Benign$miRNA))
# 
# 
# 
